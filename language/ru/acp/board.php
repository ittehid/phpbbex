...
// Avatar Settings
$lang = array_merge($lang, [
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'Аватары — это небольшие индивидуальные изображения, которые пользователи могут ассоциировать со своими учётными записями. В зависимости от выбранного стиля, аватары обычно отображаются под именем пользователя при просмотре тем. Здесь вы можете настроить использование аватар пользователями. Пожалуйста, учтите, что для загрузки аватар необходимо создать каталог, имя которого задаётся ниже, и удостовериться в том, что веб-сервер имеет права на запись в этот каталог. Учтите также, что ограничения на размер файлов накладываются только на загружаемые на сервер аватары и не распространяются на удалённые изображения.',

	'ALLOW_AVATARS'					=> 'Включить аватары',
	'ALLOW_AVATARS_EXPLAIN'			=> 'Глобальное включение или отключение возможности использования аватар.<br />Примечание: если вы отключите аватары в целом или запретите использование некоторых режимов аватар, то отключённые аватары больше не будут отображаться на форуме, но пользователи по-прежнему смогут загружать свои аватары в пользовательской панели управления.',
	'ALLOW_AVATAR_LOCAL'			=> 'Включить галерею аватар',
	'ALLOW_AVATAR_REMOTE'			=> 'Разрешить отображение аватар по внешней ссылке',
	'ALLOW_AVATAR_REMOTE_EXPLAIN'	=> 'Не рекомендуется! Аватара будет отображаться напрямую с указанного адреса.',
	'ALLOW_AVATAR_REMOTE_UPLOAD'			=> 'Разрешить загрузку аватар по URL',
	'ALLOW_AVATAR_REMOTE_UPLOAD_EXPLAIN'	=> 'Изображение по ссылке будет скопировано на форум и пройдёт все проверки.',
	'ALLOW_AVATAR_UPLOAD'			=> 'Разрешить загрузку аватар с компьютера',
...
// Auth settings
$lang = array_merge($lang, [
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBBex поддерживает расширения аутентификации, или модули. Они позволяют вам установить способ аутентификации пользователей при их входе на форум. По умолчанию доступны три модуля: DB, LDAP и Apache. Не все методы требуют дополнительной информации, поэтому заполняйте только те поля, которые необходимы для выбранного метода.',

	'AUTH_METHOD'				=> 'Выбрать метод аутентификации',

	'APACHE_SETUP_BEFORE_USE'	=> 'Необходимо настроить аутентификацию Apache при переключении phpBBex на этот метод аутентификации. Помните, что имя пользователя для аутентификации в Apache должно совпадать с вашим именем пользователя в phpBBex. Аутентификация Apache может использоваться только с mod_php (не с версией CGI).',
	...
	'LDAP_EMAIL_EXPLAIN'			=> 'Задайте имя атрибута email пользователя (если он существует) для автоматического присвоения email-адресов новым пользователям. Если это поле оставить пустым, то email-адреса пользователей, которые впервые вошли на форум, также будут пустыми.',
	...
	'LDAP_USER_EXPLAIN'				=> 'Оставьте поле пустым для использования анонимного соединения. Если поле заполнено, phpBBex использует указанное имя при соединении с сервером LDAP для поиска правильного пользователя. Например, <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Требуется для серверов Active Directory.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Опция определяет, могут ли пользователи автоматически входить на форум при его очередном посещении.',
	'AUTOLOGIN_LENGTH'				=> 'Время действия автоматического входа (дней)',
	'AUTOLOGIN_LENGTH_EXPLAIN'		=> 'Количество дней, в течение которого пользователь может автоматически входить на форум. Введите 0 для снятия ограничений.',
